...
export const STATUS_THEME: Record<PedidoStatus, StatusTheme> = {
  ...
  AGUARDANDO_PAGAMENTO: {
    ...
    columnAccent: 'from-indigo-400 to-indigo-300',
    columnBorder: 'border-indigo-200',
    columnHeaderBg: 'bg-indigo-50',
    columnHeaderText: 'text-indigo-900',
    dragOverBg: 'bg-indigo-100/80',
    dragOverRing: 'ring-indigo-500',
  },
  EM_PRODUCAO: {
    label: 'Em Produção',
    dot: 'bg-[#8e5a3a]',
