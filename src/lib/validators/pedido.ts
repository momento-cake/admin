...
export const createPedidoSchema = z.object({
  ...
  origem: z.enum(['ONLINE', 'LOJA']).default('LOJA'),
});
...
export const updatePedidoSchema = z.object({
  ...
  origem: z.enum(['ONLINE', 'LOJA']).optional(),
  ...
  nfModelo: z.union([z.literal(55), z.literal(65)]).nullable().optional(),
  nfSerie: z.number().int().nullable().optional(),
  nfNumero: z.number().int().nullable().optional(),
  nfAccessKey: z.string().nullable().optional(),
  nfProtocolo: z.string().nullable().optional(),
  nfAmbiente: z.enum(['homologacao', 'producao']).nullable().optional(),
  nfXmlPath: z.string().nullable().optional(),
  nfDanfePath: z.string().nullable().optional(),
  nfQrCode: z.string().nullable().optional(),
  nfUrlChave: z.string().nullable().optional(),
  nfCancelledAt: z.any().nullable().optional(),
  nfCancelJustificativa: z.string().nullable().optional(),
  nfCancelProtocolo: z.string().nullable().optional(),
  nfCancelXmlPath: z.string().nullable().optional(),
